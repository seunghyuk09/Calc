...
const DICT = {
  ko: {
    ...
    'tab.music': '음악', 'tab.ai': 'AI 검색', 'tab.settings': '설정',
    // ---- '오늘' 위젯 ----
    ...
    'cz.card.music.player': 'YouTube 플레이어', 'cz.card.music.links': '음악 서비스 바로가기',
  ...
  en: {
    ...
    'tab.music': 'Music', 'tab.ai': 'AI search', 'tab.settings': 'Settings',
    // ---- Today widgets ----
    ...
    'cz.card.music.player': 'YouTube player', 'cz.card.music.links': 'Music services',
