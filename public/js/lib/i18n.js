...
const DICT = {
  ko: {
    ...
    'today.swipe': '← 좌우로 쓸어 탭 이동 →',
    'today.launcher.label': '기능 바로가기',
    'today.quick.title': '바로 적기',
    'today.quick.hint': '탭을 옮기지 않아도 됩니다',
    'today.quick.todo': '할 일',
    'today.quick.todoPlaceholder': '오늘 할 일 한 줄',
    'today.quick.todoAdd': '할 일 추가',
    'today.quick.todoDone': (text) => `오늘 할 일에 넣었습니다 — ${text}`,
    'today.quick.calc': '계산',
    'today.quick.calcPlaceholder': '예: 12000*3',
    'today.quick.calcGo': '계산하기',
    'today.quick.calcError': '계산할 수 없습니다',
    'today.quick.memo': '메모',
    'today.quick.memoPlaceholder': '기억해 둘 것 한 줄',
    'today.quick.memoAdd': '메모 저장',
    'today.quick.memoDone': '메모에 저장했습니다',
    'today.clock.hint': '눌러서 스톱워치 열기',
    'today.timer.hint': '눌러서 타이머 맞추기',
    'today.quote.hint': '눌러서 글귀 더 보기',
    'today.memo.hint': '눌러서 메모장 열기',
    'today.calc.hint': '눌러서 계산기 열기',
  ...
  en: {
    ...
    'today.swipe': '← swipe to switch tools →',
    'today.launcher.label': 'Jump to a tool',
    'today.quick.title': 'Quick add',
    'today.quick.hint': 'No need to switch tabs',
    'today.quick.todo': 'Task',
    'today.quick.todoPlaceholder': "One line for today's task",
    'today.quick.todoAdd': 'Add task',
    'today.quick.todoDone': (text) => `Added to today — ${text}`,
    'today.quick.calc': 'Calculate',
    'today.quick.calcPlaceholder': 'e.g. 12000*3',
    'today.quick.calcGo': 'Calculate',
    'today.quick.calcError': "Can't calculate that",
    'today.quick.memo': 'Note',
    'today.quick.memoPlaceholder': 'One line to remember',
    'today.quick.memoAdd': 'Save note',
    'today.quick.memoDone': 'Saved to your notes',
    'today.clock.hint': 'Tap for the stopwatch',
    'today.timer.hint': 'Tap to set a timer',
    'today.quote.hint': 'Tap for more quotes',
    'today.memo.hint': 'Tap to open notes',
    'today.calc.hint': 'Tap to open the calculator',
