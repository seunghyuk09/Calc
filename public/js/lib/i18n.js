...
const DICT = {
  ko: {
    ...
    'app.loading': '불러오는 중',
    'app.backToToday': '오늘 탭으로 돌아가기',
    // ---- 처음 켰을 때 보여 주는 사용 안내 ----
    'intro.skip': '건너뛰기',
    'intro.prev': '이전',
    'intro.next': '다음',
    'intro.start': '시작하기',
    'intro.again': '사용법 다시 보기',
    'intro.progress': (i, n) => `${n}장 중 ${i}장`,
    'intro.move.title': '좌우로 쓸어서 옮겨 다닙니다',
    'intro.move.text': '이 앱에는 탭 막대가 없습니다. 화면을 좌우로 쓸면 다음 기능으로 넘어가고, 왼쪽 위 ••• 을 누르면 전체 목록이 열립니다.',
    'intro.today.title': "'오늘' 이 첫 화면입니다",
    'intro.today.text': '날씨와 오늘 할 일을 한눈에 봅니다. 어느 탭에 있든 오른쪽 아래 오늘 버튼을 누르면 바로 돌아옵니다.',
    'intro.plan.title': '계획은 네 가지 단위로',
    'intro.plan.text': 'TO DO 탭에서 일간·주간·월간·연간을 골라 적습니다. 달력 모양도 고른 단위를 그대로 따라갑니다.',
    'intro.arrange.title': '카드를 꾹 눌러 옮깁니다',
    'intro.arrange.text': '아무 카드나 길게 누르면 편집이 켜집니다. 끌어서 순서를 바꾸고 크기를 고를 수 있습니다. 테마와 탭 구성은 설정 탭에서 바꿉니다.',
    'intro.data.title': '기록은 이 기기에만 남습니다',
    'intro.data.text': '서버로 올라가지 않습니다. 앱을 지우거나 기기를 바꾸면 사라지므로, 설정 탭에서 가끔 백업해 두세요.',
    ...
    'todo.hours.empty': '시각을 정한 일이 없습니다. 아래에서 모든 시간을 펼쳐 넣을 수 있습니다.',
    'todo.hours.showAll': '모든 시간 보기',
    'todo.hours.showLess': '일정 있는 시간만 보기',
    'arr.open': '화면 편집',
    'arr.done': '완료',
    ...
    // ---- 달력 ----
    // 달력 모양은 계획표 단위를 따릅니다. 화면 읽기용 이름도 모양마다 다릅니다.
    'cal.empty': '이 날은 등록된 일이 없습니다.',
    'cal.count': (n) => `${n}건`,
    'cal.undone': (n) => `미완료 ${n}건`,
    'cal.aria.day': '고른 날짜',
    'cal.toMonth': '눌러서 한 달 달력 보기',
    'cal.aria.week': '한 주 달력',
    'cal.aria.month': '한 달 달력',
    'cal.aria.year': '열두 달 달력',
  ...
  en: {
    'app.loading': 'Loading',
    'app.backToToday': 'Back to the Today tab',
    // ---- First-run guide ----
    'intro.skip': 'Skip',
    'intro.prev': 'Back',
    'intro.next': 'Next',
    'intro.start': 'Get started',
    'intro.again': 'Show the guide again',
    'intro.progress': (i, n) => `Step ${i} of ${n}`,
    'intro.move.title': 'Swipe left and right to move',
    'intro.move.text': 'There is no tab bar. Swipe sideways to reach the next tool, or tap ••• at the top left for the full list.',
    'intro.today.title': 'Today is your home screen',
    'intro.today.text': 'It shows the weather and what you planned for today. Wherever you are, the Today button at the bottom right brings you straight back.',
    'intro.plan.title': 'Plan by day, week, month or year',
    'intro.plan.text': 'Pick a scope in the TO DO tab and write there. The calendar changes shape to match the scope you picked.',
    'intro.arrange.title': 'Press and hold a card to move it',
    'intro.arrange.text': 'Long-press any card to turn on editing. Drag to reorder and choose a size. Themes and which tabs to show live in Settings.',
    'intro.data.title': 'Everything stays on this device',
    'intro.data.text': 'Nothing is uploaded to a server. Deleting the app or changing devices loses it, so export a backup from Settings now and then.',
    ...
    'todo.hours.empty': 'Nothing has a time yet. Expand all hours below to add one.',
    'todo.hours.showAll': 'Show all hours',
    'todo.hours.showLess': 'Only hours with plans',
    ...
    'cal.aria.day': 'Selected date',
    'cal.toMonth': 'Tap to see the whole month',
    'cal.aria.week': 'Week calendar',
    'cal.aria.month': 'Month calendar',
    'cal.aria.year': 'Year calendar',
