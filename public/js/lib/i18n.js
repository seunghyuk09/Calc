...
const DICT = {
  ko: {
    ...
    'cal.prev': '이전 달',
    'cal.next': '다음 달',
    'cal.pick': '날짜를 누르면 그 날의 할 일이 펼쳐집니다.',
    'cal.empty': '이 날은 등록된 일이 없습니다.',
    'cal.count': (n) => `${n}건`,
    'cal.undone': (n) => `미완료 ${n}건`,
    'cal.goHint': '눌러서 계획표에서 보기',
    'cal.note': '일간 계획만 표시합니다. 주간·월간·연간은 특정 날짜에 속하지 않습니다.',
    'cal.aria.grid': '월 달력',
  ...
  en: {
    ...
    'cal.next': 'Next month',
    'cal.pick': 'Tap a date to see what is planned that day.',
    ...
    'cal.note': 'Only daily plans appear here. Weekly, monthly and yearly plans do not belong to one date.',
